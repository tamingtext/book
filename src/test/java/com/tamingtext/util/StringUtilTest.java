...
public class StringUtilTest extends TamingTextTestJ4 {
  ...
  public void testLuceneStandardTokenizer() throws Exception {
    ...
    StandardTokenizer tokenizer = new StandardTokenizer(Version.LUCENE_46, new StringReader("I can't beleive that the Carolina Hurricanes won the 2005-2006 Stanley Cup."));
  ...
  public void testVikings() throws Exception {
    ...
    StandardTokenizer tokenizer = new StandardTokenizer(Version.LUCENE_46, new StringReader("Last week the National Football League crowned a new Super Bowl Champion." +
            "  Minnesota Vikings fans will take little solace in the fact that they" +
            " lost to the eventual champion in the playoffs."));
    List<String> result = new ArrayList<String>();
    while (tokenizer.incrementToken()) {
