...
public class MoreLikeThisQueryTest {
  ...
  public void testMoreLikeThisQuery() throws Exception {
    ...
    IndexReader indexReader = DirectoryReader.open(directory); //<co id="mlt.indexsetup"/> 
    ...
    Query query = moreLikeThis.like(reader, null);
    ...
    System.out.println(query); //<co id="mlt.displayquery"/>
    
    System.out.println("===== results =====");
    for (CategoryHits c: sortedCats) { //<co id="mlt.display"/>
      System.out.println(
          c.getLabel() + "\t" + c.getScore() + "\t" + c.getHits());
    }
    ...
    <callout arearefs="mlt.display">Display Query</callout>
    <callout arearefs="mlt.display">Display Categories</callout>
    <callout arearefs="mlt.display">Explain best result</callout>
    </calloutlist>*/
